  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', paddingTop: '70px', minHeight: '360px', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, #070c14 0%, #0c1a2e 60%, #1a0f00 100%)' }} />
        <div className="grid-overlay" />
        <div style={{ position: 'absolute', top: '30%', right: '20%', width: 280, height: 280, background: 'rgba(245,166,35,0.07)', borderRadius: '50%', filter: 'blur(70px)', zIndex: 1 }} />
