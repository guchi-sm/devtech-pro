export default function DevTechLogo({ height = 36 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 52" height={height} style={{ display: 'block' }}>
      <defs>
      ...
      <path d="M 25 16 Q 39 16 39 26 Q 39 36 25 36" fill="none" stroke="url(#nOrange)" strokeWidth="5" strokeLinecap="round"/>
      ...
      <text x="58" y="34" fontFamily="'Arial Black', 'Helvetica Neue', sans-serif" fontSize="26" fontWeight="900" letterSpacing="-1" fill="var(--text, #ffffff)">DEV</text>
      <text x="120" y="34" fontFamily="'Arial Black', 'Helvetica Neue', sans-serif" fontSize="26" fontWeight="900" letterSpacing="-1" fill="url(#nOrange)">TECH</text>
    </svg>
  )
}