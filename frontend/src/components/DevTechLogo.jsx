export default function DevTechLogo({ height = 36 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 220 52" height={height} style={{ display: "block" }}>
      ...
      <text x="58" y="34" fontFamily="Arial Black" fontSize="26" fontWeight="900" letterSpacing="-1" fill="var(--text, #ffffff)">DEV</text>
      <text x="120" y="34" fontFamily="Arial Black" fontSize="26" fontWeight="900" letterSpacing="-1" fill="url(#nOrange)">TECH</text>
    </svg>
  )
}
