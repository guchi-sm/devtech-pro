...
const SOCIALS = [
  ...
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61574315267768',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  return (
    <footer style={{ background: 'var(--bg-2)', borderTop: '1px solid var(--border)' }}>
      <div className="max-w-[1280px] mx-auto px-8 md:px-10">
        ...
        {/* Top */}
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-10 border-b" style={{ borderColor: 'var(--border)' }}>
          <div>
            <div className="font-display text-2xl tracking-wider mb-3" style={{ color: 'var(--text)' }}>
          ...
          <div>
            <div className="font-mono text-[0.65rem] tracking-[0.2em] uppercase mb-4" style={{ color: 'var(--accent)' }}>Navigation</div>
              ...
              {NAV_LINKS.map(({ to, label }) => (
                <li key={to}>
                  <NavLink
                    ...
                    className="font-mono text-[0.72rem] tracking-[0.1em] uppercase transition-colors duration-200"
          ...
          <div>
            <div className="font-mono text-[0.65rem] tracking-[0.2em] uppercase mb-4" style={{ color: 'var(--accent)' }}>Contact</div>
            <div className="space-y-2 text-sm" style={{ color: 'var(--text-muted)' }}>
              <p>guchibrownz@gmail.com</p>
              <p>+254 790 078 363</p>
              <p>Meru, Kenya</p>
            </div>
        ...
        <div className="py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <span className="font-mono text-[0.6rem] tracking-[0.1em]" style={{ color: 'var(--text-muted)' }}>
            © {new Date().getFullYear()} DevTech Pro. All rights reserved.
          </span>
