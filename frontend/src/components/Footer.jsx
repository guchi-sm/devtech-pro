...
export default function Footer() {
  ...
  return (
    <footer style={{ position: 'relative', overflow: 'hidden' }}>
      ...
      {/* Dark overlay */}
      <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(135deg, rgba(8,12,22,.97) 0%, rgba(20,33,52,.95) 100%)', pointerEvents: 'none' }} />

      {/* Orange top accent */}
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 3, background: '#f5a623', zIndex: 5 }} />

      {/* Content */}
      <div style={{ position: 'relative', zIndex: 10 }}>

        {/* Upper grid */}
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '4.5rem 2rem 3.5rem' }}>
        ...
        {/* Bottom bar */}
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '1.4rem 2rem' }}>
          <div className="footer-bottom">
            <p style={{ fontFamily: 'monospace', fontSize: '.63rem', letterSpacing: '.14em', textTransform: 'uppercase', color: 'rgba(255,255,255,.25)', margin: 0 }}>
